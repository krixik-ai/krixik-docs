...
The [`transcribe`](../modules/ai_model_modules/transcribe_module.md)  module accepts audio and video inputs. Acceptable file formats are MP3 and MP4, although the latter has its audio locally extracted—and the video portion left aside—before processing.
...
process_output_2 = pipeline_1.process(local_file_path="../../data/input/Interesting Facts About Colombia.mp4", # all parameters save 'modules' as above
